...
public interface DataBase {
    ...
    /**
     * update a single entity with conflict algorithm, and only update columns in {@link com.litesuits.orm.db.model.ColumnsValue}
     * if param {@link com.litesuits.orm.db.model.ColumnsValue} is null, update all columns.
     *
     * @return the number of affected rows
     */
    ...
    /**
     * update a collection with conflict algorithm, and only update columns in {@link com.litesuits.orm.db.model.ColumnsValue}
     * if param {@link com.litesuits.orm.db.model.ColumnsValue} is null, update all columns.
     *
     * @return the number of affected rows
     */
    ...
    /**
     * get {@link com.litesuits.orm.db.impl.SQLiteHelper}
     */
     ...
     * Equivalent to {@link android.database.sqlite.SQLiteDatabase#openDatabase(String, android.database.sqlite.SQLiteDatabase.CursorFactory, int, android.database.DatabaseErrorHandler)}.
     */
