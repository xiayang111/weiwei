...
public class CouponListEntity {
	...
	private float OrderAmountLower; //订单金额下限
	...
	public void setLimitProducts(ArrayList<LimitProducts> limitProducts) {
	...
	public void setOrderAmountLower(float orderAmountLower) {
	...
	public String toString() {
		return "CouponListEntity [CouponTypeId=" + CouponTypeId + ", Name="
