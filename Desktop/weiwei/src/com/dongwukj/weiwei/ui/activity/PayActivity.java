...
public class PayActivity extends Activity {
	...
	private class GetPrepayIdTask extends AsyncTask<Void, Void, Map<String,String>> {
		...
		protected void onPreExecute() {
			dialog = ProgressDialog.show(PayActivity.this, "提示", "加载中");
		}
   ...
   //
	...
	private void genPayReq() {
		...
		req.appId="wx9e40b72027b535fc";
		req.partnerId="1241955502";
		req.prepayId="wx20150528192311a29e005efe0655220348";
		req.nonceStr="124195550220150528192307517";
		req.timeStamp="1432812187";
