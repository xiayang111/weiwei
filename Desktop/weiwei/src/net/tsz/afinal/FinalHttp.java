...
public class FinalHttp {
    ...
    private static int maxRetries = 1;//错误尝试次数，错误异常表请在RetryHandler添加
    ...
    public FinalHttp(final String version) {
        ...
        httpClient.addRequestInterceptor(new HttpRequestInterceptor() {
            public void process(HttpRequest request, HttpContext context) {
                ...
                if (!request.containsHeader("vvverion")) {
                	request.addHeader("vvverion", version);
				}
